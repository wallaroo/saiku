...
call git pull
call mvn clean package install:install-file -Dfile=target/saiku-ui-MONDRIAN4-SNAPSHOT.war  -DgroupId=org.saiku -DartifactId=saiku-ui -Dversion=MONDRIAN4-SNAPSHOT -Dpackaging=war
